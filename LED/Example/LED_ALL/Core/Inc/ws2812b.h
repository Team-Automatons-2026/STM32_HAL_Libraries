...
#define WS2812B_T0H             34      /* Duty for bit '0'           */
...
#define CRGB_Silver      ((CRGB){192, 192, 192})

#define CRGB_SkyBlue     ((CRGB){135, 206, 235})
#define CRGB_Aqua        ((CRGB){  0, 255, 180})
#define CRGB_Teal        ((CRGB){  0, 128, 128})

#define CRGB_Navy        ((CRGB){  0,   0, 128})
#define CRGB_RoyalBlue   ((CRGB){ 65, 105, 225})
#define CRGB_Turquoise   ((CRGB){ 64, 224, 208})

#define CRGB_Violet      ((CRGB){238, 130, 238})
#define CRGB_Indigo      ((CRGB){ 75,   0, 130})
#define CRGB_Lavender    ((CRGB){230, 230, 250})

#define CRGB_Brown       ((CRGB){165,  42,  42})
#define CRGB_Maroon      ((CRGB){128,   0,   0})
#define CRGB_Chocolate   ((CRGB){210, 105,  30})

#define CRGB_Olive       ((CRGB){128, 128,   0})
#define CRGB_ForestGreen ((CRGB){ 34, 139,  34})
#define CRGB_DarkGreen   ((CRGB){  0, 100,   0})

#define CRGB_Coral       ((CRGB){255, 127,  80})
#define CRGB_Salmon      ((CRGB){250, 128, 114})
#define CRGB_Crimson     ((CRGB){220,  20,  60})

#define CRGB_HotPink     ((CRGB){255, 105, 180})
#define CRGB_DeepPink    ((CRGB){255,  20, 147})

#define CRGB_Amber       ((CRGB){255, 191,   0})
#define CRGB_Khaki       ((CRGB){240, 230, 140})

#define CRGB_Mint        ((CRGB){152, 255, 152})
#define CRGB_IceBlue     ((CRGB){173, 216, 230})
